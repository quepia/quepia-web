...
| `CRON_SECRET` | Secreto largo para proteger las rutas ejecutadas por Vercel Cron |
| `NEXT_PUBLIC_SITE_URL` | URL pública del sitio, usada para links en emails (ej. `https://quepia.com`) |
| `TASK_NOTIFICATIONS_TIME_ZONE` | Zona horaria para digest de tareas, por defecto `America/Argentina/Cordoba` |
