...
export function BriefingForm({ projectId, projectType, initialData, isOpen, onClose, onSave }: BriefingFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full h-[100svh] sm:h-auto sm:max-h-[90vh] sm:max-w-2xl bg-[#0a0a0a] border-0 sm:border sm:border-white/10 rounded-t-2xl sm:rounded-xl shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
