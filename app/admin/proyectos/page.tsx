        ...
        <div>
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-400">Gestiona los proyectos de tu portfolio</p>
                </div>
                                ...
                                <tr key={proyecto.id}>
                                    <td>
                                        {proyecto.imagen_url ? (
                                            ...
                                            <div className="w-16 h-12 rounded-lg bg-white/5 flex items-center justify-center text-gray-500">
                                                Sin img
                                            </div>
                                        )}
                                    </td>
                                    <td className="text-white font-medium">{proyecto.titulo}</td>
                                    <td>
