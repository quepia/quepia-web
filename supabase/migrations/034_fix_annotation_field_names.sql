-- Migration 034: Fix annotation field names in get_client_project_data and V2 variant
--
-- Problem: SQL returns 'content', 'x', 'y' but the TypeScript Annotation interface
-- expects 'contenido', 'x_percent', 'y_percent'. This causes annotation text to not
-- display and positions to be wrong.

-- 1. Fix V1: get_client_project_data
...
BEGIN
    ...
    -- 4. Get tasks with assets (FIXED annotation field names)
...
-- 2. Fix V2: get_client_project_data_v2
