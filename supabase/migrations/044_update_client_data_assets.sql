-- Migration 044: Include asset storage paths and access_revoked in client data RPCs

-- Update get_client_project_data (V1)
...
BEGIN
    ...
    -- 2. Get project info
    SELECT id, nombre, color, owner_id, icon, logo_url INTO project_record
...
-- Update get_client_project_data_v2 (V2/Session)
...
BEGIN
    ...
    -- 4. Get Tasks (WITH ASSETS + SOCIAL_COPY)
