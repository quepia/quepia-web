...
const team = [
  {
    ...
    bio: 'Apasionado por el diseño y la tecnología. Lidera la visión creativa de Quepia, transformando ideas en experiencias visuales memorables.',
    image: 'https://placehold.co/400x500/1a1a1a/881078/png?text=Lautaro',
    social: {
      instagram: '#',
      linkedin: '#',
      email: 'lautaro@quepia.com'
    }
  },
  {
    name: 'Camila De Angelis',
    role: 'Co-Fundadora & Directora de Estrategia',
    bio: 'Especialista en branding y comunicación. Se encarga de que cada proyecto conecte emocionalmente con el público objetivo.',
    image: 'https://placehold.co/400x500/1a1a1a/2AE7E4/png?text=Camila',
    social: {
      instagram: '#',
      linkedin: '#',
      email: 'camila@quepia.com'
    }
  }
];
      ...
      >
        ...
        >
          <div className="container mx-auto px-4 md:px-6">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-display font-bold mb-6 md:mb-8 leading-tight">
                Más que una{' '}
        ...
        {/* Nuestra Historia */}
        <section
          className="py-12 md:py-20 border-y border-white/10"
          style={{ opacity: 1, visibility: 'visible' }}
        >
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
              ...
              <motion.div
                ...
                style={{ opacity: mounted ? undefined : 1, visibility: 'visible' }}
              >
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold mb-4 md:mb-6 text-white">
                  Nuestra Historia
                </h2>
        ...
        {/* Nuestros Valores */}
        <section
          className="py-12 md:py-20 border-t border-white/10"
          style={{ opacity: 1, visibility: 'visible' }}
        >
          <div className="container mx-auto px-4 md:px-6">
            <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              {values.map((value, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg md:text-xl font-bold font-display text-white mb-2 md:mb-3">
                    {value.title}
                  </h3>
